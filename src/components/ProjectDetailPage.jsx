...
import NexoraProjectDetailPage from './nexora/NexoraProjectDetailPage'
...
export default function ProjectDetailPage() {
  ...
  // Render custom Nexora detail page if projectId is 'nexora' or 'nexorav2'
  if (projectId && (projectId.toLowerCase() === 'nexora' || projectId.toLowerCase() === 'nexorav2')) {
    return <NexoraProjectDetailPage />
  }
